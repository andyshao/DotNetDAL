...
namespace Voron.Impl
{
    public sealed unsafe class LowLevelTransaction : IPagerLevelTransactionState
    {
        ...
        public readonly List<JournalSnapshot> JournalSnapshots = new List<JournalSnapshot>();
        ...
        public class WriteTransactionPool
        {
#if DEBUG
        ...
        public FixedSizeTree _freeSpaceTree;
        ...
        public void UpdateRootsIfNeeded(Tree root)
        {
        ...
        public HashSet<PageFromScratchBuffer> GetTransactionPages()
        {
            VerifyNoDuplicateScratchPages();
            return _transactionPages;
        }

        public List<PageFromScratchBuffer> GetUnusedScratchPages()
        {
            return _unusedScratchPages;
        }

        public HashSet<long> GetFreedPagesNumbers()
        {
            return _freedPages;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Page ModifyPage(long num)
        {
            ...
            return ModifyPagepublic(num);
        }

        private Page ModifyPagepublic(long num)
        {
        ...
        public Page GetPage(long pageNumber)
        {
            ...
            return GetPagepublic(pageNumber);
        }

        private Page GetPagepublic(long pageNumber)
        {
        ...
        public void BreakLargeAllocationToSeparatePages(long pageNumber)
        {
            if (_disposed)
                throw new ObjectDisposedException("Transaction");
        ...
        public void ShrinkOverflowPage(long pageNumber, int newSize, TreeMutableState treeState)
        {
            if (_disposed)
                throw new ObjectDisposedException("Transaction");
        ...
        public void FreePageOnCommit(long pageNumber)
        {
        ...
        public ActiveTransactions.Node ActiveTransactionNode;
        public bool FlushInProgressLockTaken;
        private ByteString _txHeaderMemory;
        public ImmutableAppendOnlyList<JournalFile> JournalFiles;
        public bool AlreadyAllowedDisposeWithLazyTransactionRunning;
        public DateTime TxStartTime;
        public long? LocalPossibleOldestReadTransaction;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void OnAfterCommitWhenNewReadTransactionsPrevented()
        {
