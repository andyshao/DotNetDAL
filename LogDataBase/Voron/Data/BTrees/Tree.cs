...
namespace Voron.Data.BTrees
{
    public unsafe partial class Tree : IDisposable
    {
        ...
        public void RemoveLeafNode(TreePage page)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TreePage GetReadOnlyTreePage(long pageNumber)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TreePage GetWriteableTreePage(long pageNumber)
        {
            var page = _llt.ModifyPage(pageNumber);
            return new TreePage(page.Pointer, Constants.Storage.PageSize);
        }

        public TreePage FindPageFor(Slice key, out TreeNodeHeader* node)
        {
            TreePage p;
        ...
        public TreePage FindPageFor(Slice key, out TreeNodeHeader* node, out TreeCursorConstructor cursor, bool allowCompressed = false)
        {
            TreePage p;
        ...
        public TreePage NewPage(TreePageFlags flags, long nearbyPage)
        {
        ...
        public void FreePage(TreePage p)
        {
#if VALIDATE
            p.Freed = true;
#endif
        ...
        public void SetNewPageAllocator(NewPageAllocator newPageAllocator)
        {
