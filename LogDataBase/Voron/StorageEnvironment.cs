...
namespace Voron
{
    ...
    public class StorageEnvironment : IDisposable
    {
        ...
        public readonly LowLevelTransaction.WriteTransactionPool WriteTransactionPool =
        ...
        public readonly ThreadHoppingReaderWriterLock FlushInProgressLock = new ThreadHoppingReaderWriterLock();
        ...
        public int SizeOfUnflushedTransactionsInJournalFile;
        ...
        public static bool IsStorageSupportingO_Direct(Logger log, string path)
        {
        ...
        public LowLevelTransaction NewLowLevelTransaction(TransactionPersistentContext transactionPersistentContext, TransactionFlags flags, ByteStringContext context = null, TimeSpan? timeout = null)
        {
        ...
        public void IncrementUsageOnNewTransaction()
        {
            if (_envDispose.TryAddCount(1) == false)
                ThrowCurrentlyDisposing();
        }

        public void DecrementUsageOnTransactionCreationFailure()
        {
        ...
        public ExitWriteLock PreventNewReadTransactions()
        {
        ...
        public void TransactionAfterCommit(LowLevelTransaction tx)
        {
        ...
        public void TransactionCompleted(LowLevelTransaction tx)
        {
        ...
        public void BackgroundFlushWritesToDataFile()
        {
            try
            {
        ...
        public void AllowDisposeWithLazyTransactionRunning(LowLevelTransaction tx)
        {
