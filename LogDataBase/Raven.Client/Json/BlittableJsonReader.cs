...
namespace Raven.Client.Json
{
    internal class BlittableJsonReader : JsonReader
    {
        ...
        public override DateTime? ReadAsDateTime()
        {
            ...
            if (str == null)
                return null;
            return DateTime.ParseExact(str, DateTimeFormatsToRead, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind);
        }
        ...
        public override DateTimeOffset? ReadAsDateTimeOffset()
        {
            ...
            if (str == null)
                return null;
            return DateTimeOffset.ParseExact(str, DateTimeFormatsToRead, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind);
        }
    }
