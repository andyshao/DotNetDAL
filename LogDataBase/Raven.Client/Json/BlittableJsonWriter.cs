...
namespace Raven.Client.Json
{
    internal class BlittableJsonWriter : JsonWriter
    {
        ...
        {
            var s = value.ToString("o");//DefaultFormat.DateTimeOffsetFormatsToWrite
            _manualBlittableJsonDocumentBuilder.WriteValue(s);
        }
        ...
        {
            if (value != null)
                _manualBlittableJsonDocumentBuilder.WriteValue(value.Value.ToString("o"));//DefaultFormat.DateTimeOffsetFormatsToWrite
            else
                _manualBlittableJsonDocumentBuilder.WriteValueNull();
        }
