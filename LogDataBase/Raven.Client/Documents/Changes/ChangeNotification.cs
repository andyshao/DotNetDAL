...
namespace Raven.Client.Documents.Changes
{
    public class DocumentChange : DatabaseChange
    {
        ...
        public bool TriggeredByReplicationThread;
        ...
        public static DocumentChange FromJson(BlittableJsonReaderObject value)
        {
    ...
    public class IndexChange : DatabaseChange
    {
        ...
        public static IndexChange FromJson(BlittableJsonReaderObject value)
        {
